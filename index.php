            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
                        <li><a href="#body">ترحيب
</a></li>
                        <li><a href="#service">قسم المشتركين
</a></li>
                        <li><a href="#portfolio">برنامج الدكتور مصطفى أبو سعد
</a></li>
                        <li><a href="#testimonials">اتصل بالدعم الفني
</a></li>
                        <li><a href="#price">مرفقات مجانية
</a></li>
                        <li><a href="#contact">اتصل
</a></li>
                    </ul>
                </nav>
				<!-- /main nav -->
						...
						<div class="col-md-4 wow animated fadeInLeft">
							<div class="recent-works">
								...
								<div id="works">
									...
									<img src="img/im1.jpg" class="pull-left" alt="member">
										<h3>التواصل المباشر
</h3>
